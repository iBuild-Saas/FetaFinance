...
BEGIN
    ...
    WITH RECURSIVE account_hierarchy AS (
        ...
        SELECT 
            ...
            c.is_group,
            ah.level_depth + 1,
            ah.sort_path || '.' || c.account_code as sort_path
...
SELECT 'Fixed hierarchical financial statement functions created successfully' as status;

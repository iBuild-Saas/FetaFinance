-- Minimal delivery function that only uses basic fields that exist in most stock_movements tables
...
-- 2. Create minimal delivery function with only basic fields
...
BEGIN
    ...
    LOOP
        ...
        -- Create stock movement record with minimal fields only
...
SELECT 'Created minimal delivery function with basic fields only' as status;

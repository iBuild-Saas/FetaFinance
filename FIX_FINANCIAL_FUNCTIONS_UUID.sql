-- Update financial statement functions to work with UUID company IDs

DROP FUNCTION IF EXISTS get_income_statement(TEXT, DATE, DATE);
DROP FUNCTION IF EXISTS get_balance_sheet(TEXT, DATE);

-- Income Statement function that accepts UUID company IDs
...
-- Balance Sheet function that accepts UUID company IDs
...
-- Test with actual UUID from your database
SELECT 'Testing with UUID company ID:' as test_message;
SELECT * FROM get_income_statement('33105b2a-b01f-49f3-9b44-a15632da7435', '2024-01-01', '2024-12-31') LIMIT 5;
SELECT * FROM get_balance_sheet('33105b2a-b01f-49f3-9b44-a15632da7435', '2024-12-31') LIMIT 5;

SELECT 'Functions updated to work with UUID company IDs' as status;

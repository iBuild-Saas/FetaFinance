-- =====================================================
-- UPDATE SALES AUTOMATION FOR EXISTING SCHEMA
-- =====================================================
-- This script updates the automation functions to work with your existing
-- sales_invoices and sales_invoice_line_items tables

-- =====================================================
-- 1. UPDATE SALES INVOICE STOCK MOVEMENT FUNCTION
-- =====================================================
...
-- =====================================================
-- 4. ADD MISSING COMPANY ACCOUNT FIELDS (IF NOT EXISTS)
-- =====================================================
...
SELECT '=== SALES AUTOMATION UPDATED FOR EXISTING SCHEMA ===' as status;
